...
class ListViewTest(TestCase):
    ...
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.assertEqual(new_item.text, 'A new item added to correct list')
    ...
    def test_for_invalid_input_isnt_saved_to_db(self):
...
class MyListsTest(TestCase):
    ...
    def test_passes_correct_owner_to_complete(self):
